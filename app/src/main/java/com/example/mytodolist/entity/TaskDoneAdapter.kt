...
class TaskDoneAdapter(var taskDoneList:List<Task>):
    RecyclerView.Adapter<TaskDoneAdapter.ViewHolder>(){
    ...
    override fun getItemCount() = taskDoneList.size
